...
class ListFragment : Fragment() {
    ...
    private lateinit var viewModel: ListFragmentData
    ...
    override fun onCreateView(
        ...
        val recyclerView : RecyclerView = rootView.findViewById(R.id.rvStudentList)
        val repository = StudentRepository(StudentDatabase.getInstance(requireContext()))

        viewModel = ViewModelProvider(this)[ListFragmentData::class.java]

        viewModel.data.observe(viewLifecycleOwner){
            adapter = StudentAdapter(requireContext(),it,repository, viewModel)
